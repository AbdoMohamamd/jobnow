...
const JobCategorieCard = ({ icon, title, numberOfJobs }) => {
  return (
    <div className=' w-28 h-24 pl-3 pt-3 pr-8  md:w-72 md:pt-8 md:pl-7 md:h-64  md:pr-20 hover:bg-primary-color bg-white rounded-xl  relative group transition ease-in-out duration-300'>
